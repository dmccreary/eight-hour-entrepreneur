# AI Agent Instructions — The Eight-Hour Entrepreneur

Welcome, Agent. You have been asked to generate, edit, or validate content for
the **The Eight-Hour Entrepreneur** intelligent textbook.
...
| | |
|---|---|
| Book title | The Eight-Hour Entrepreneur |
| Published site | https://dmccreary.github.io/eight-hour-entrepreneur/ |
...
- The published lesson URL is
  `https://dmccreary.github.io/eight-hour-entrepreneur/sims/<sim-id>/`. Always
