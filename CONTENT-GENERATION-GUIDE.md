...
The Eight-Hour Entrepreneur — chapters, lesson plans, quizzes, FAQ entries, glossary prose,
...
- **Name**: Scout
- **Species**: Fox
- **Personality**: Scrappy, Resourceful, Encouraging, Curious
- **Catchphrase**: "Let's find out for real!"
- **Visual**: Warm fox-orange fur with a cream underbelly and fluffy tail, small indigo field-notebook satchel slung across the chest, bright alert eyes, confident half-smile, ears perked forward
- **Pronouns**: Scout has no gender. Always write
  "Scout" or *they/them*.

### Voice Characteristics

- Plainspoken — avoids business jargon and buzzwords
- Redirects internal debate outward: asks "What did the customer actually say?" instead of speculating
- Uses light field/exploration metaphors ("Let's go knock on a door," "Time for a quick field test")
- Signature phrases: "Let's find out for real!", "Talk to a real person about that.", "Small test, real answer."
...
- **Tone**: Warm, sincere, and a little fun. Use Entrepreneurship / Lean Startup Validation-flavored
  metaphors. Include the signature catchphrase "Let's find out for real!".
- **Length**: Strictly 2-4 sentences. *(Exception: Chapter 1, where
  Scout introduces themselves — see "Chapter 1 Self-Introduction"
  below.)*
...
- Have Scout **state their name, species, and one personality
