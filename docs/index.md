...
description: 'An interactive intelligent textbook for an intensive, virtual "learning lab" designed to take early-stage entrepreneurs from an unrefined concept to a validated, launch-ready venture in 8 total hours (four 2-hour virtual sessions).'
image: img/cover.png
---
...
<figure markdown>
  ![The Eight-Hour Entrepreneur cover](./img/cover.png){ width="100%" }
</figure>

An interactive intelligent textbook for an intensive, virtual "learning lab" designed to take early-stage entrepreneurs from an unrefined concept to a validated, launch-ready venture in 8 total hours (four 2-hour virtual sessions).
